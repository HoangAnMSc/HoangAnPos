...
const RevenuePage = lazy(() =>
  import("./pages/RevenuePage").then((module) => ({
...
const WarehouseHubPage = lazy(() =>
  import("./pages/WarehouseHubPage").then((module) => ({
    default: module.WarehouseHubPage,
  })),
);

function DefaultAdminRedirect() {
  const { canAccess } = useAuth();
  const firstAllowedPage = appPermissions.find((permission) =>
    canAccess(permission.key),
  );
        ...
        <Route element={<ProtectedRoute requireAdmin />}>
          <Route element={<AdminLayout />}>
            ...
            <Route
              ...
              element={<Navigate replace to="/revenue" />}
            />
            ...
            <Route
              ...
              element={<CloudinaryImagesPage />}
            />
            <Route path="warehouse" element={<WarehouseHubPage />} />
            <Route
              path="inventory"
              element={<Navigate replace to="/warehouse?tab=inventory" />}
            />
